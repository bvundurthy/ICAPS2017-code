...
for it = 1:Nsteps
    time = (it) * dt;
    [posagents, Ck] = SMC_Update_Maximin(posagents, Ck, muk, time, dt, DomainBounds, AgentSpeed);
...
figure(3)
hold on;
plot(1:Nsteps, cover_plot,'r');
xlabel('Time');
ylabel('Coverage by area');
title('Cumulative area covered by agents as a function of time')
